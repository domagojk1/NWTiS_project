 ...
 *       &lt;sequence&gt;
 *         &lt;element name="return" type="{http://soap.dkopic2.nwtis.foi.org/}rank" maxOccurs="unbounded" minOccurs="0"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class GetRankResponse {
     ...
     * 
     */
    public List<Rank> getReturn() {
        if (_return == null) {
            _return = new ArrayList<Rank>();
        }
        return this._return;
    }
