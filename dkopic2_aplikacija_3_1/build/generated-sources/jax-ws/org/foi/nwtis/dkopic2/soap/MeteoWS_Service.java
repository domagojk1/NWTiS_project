 ...
 * 
 */
@WebServiceClient(name = "MeteoWS", targetNamespace = "http://soap.dkopic2.nwtis.foi.org/", wsdlLocation = "http://localhost:8084/dkopic2_aplikacija_1/MeteoWS?wsdl")
    ...
    extends Service
{
    ...
    private final static QName METEOWS_QNAME = new QName("http://soap.dkopic2.nwtis.foi.org/", "MeteoWS");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8084/dkopic2_aplikacija_1/MeteoWS?wsdl");
    ...
    public MeteoWS getMeteoWSPort() {
        return super.getPort(new QName("http://soap.dkopic2.nwtis.foi.org/", "MeteoWSPort"), MeteoWS.class);
    }
    ...
    public MeteoWS getMeteoWSPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://soap.dkopic2.nwtis.foi.org/", "MeteoWSPort"), MeteoWS.class, features);
    }
